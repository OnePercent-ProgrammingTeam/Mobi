...
public class ContainerModel {
     ...
     * 2. the time that has passed since the container was running (if it is running
     * it prints: Up to *time*)
     */
     ...
     * in ContainerMonitor class we have a method that converts it to a formatted
     * date
     */
