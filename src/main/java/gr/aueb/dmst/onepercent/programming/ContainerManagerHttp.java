...
public class ContainerManagerHttp extends ContainerHttpRequest {
     ...
     *
     * This method takes an input stream, wraps it with a BufferedReader, and reads
     * its content
     * line by line. Each line is then printed to the console. The BufferedReader is
     * automatically
     * closed (It is autoclosable. That is why we use the parenthesis in try segment
     * of try-catch statement.
     * It would be the same, if we had a finally statement, in which we would
     * "close" with .close() method the
     * BufferedReader object) upon exiting the method, due to the try-with-resources
     * statement.
     *
     * @param entity The HTTP response entity containing the input stream to be
     *               read.
     * @throws IOException If an I/O error occurs while reading the input stream.
     */

    public void handleResponse() throws IOException {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(entity.getContent()))) { // Create a
                                                                                                       // reader for the
                                                                                                       // response
                                                                                                       // content
            String line;
